    ...
    group('/ai/extract', () {
      ...
      test(
        ...
        () async {
          ...
          _logRawResponse(
            caseId: 'extract-failure-1',
            endpoint: '/ai/extract',
            requestBody: input,
            response: response,
          );

          expect(_looksLikeExtractSuccess(response.data), isFalse);
        },
        skip: skipReason,
      );
...
bool _looksLikeExtractSuccess(dynamic data) {
